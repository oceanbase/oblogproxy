...
if(USE_OBCDC_NS)
    if (USE_LIBOBLOG_3)
        set(CPACK_RPM_PACKAGE_REQUIRES "devdeps-libaio >= 0.3.112, oceanbase-ce-cdc >= 3.1.3")
    else()
        set(CPACK_RPM_PACKAGE_REQUIRES "devdeps-libaio >= 0.3.112, oceanbase-ce-cdc >= 4.0.0.0")
    endif()
else()
